...
{$logo=$_config.manager_favicon_url|default:"{$_config.manager_url}templates/default/images/modx-icon-color.png"}
{$logo="/{$logo}"|replace:'//':'/'}
...
<head>
    ...
    {if $logo}<link rel="shortcut icon" type="image/x-icon" href="{$logo}" />{/if}
            ...
            <div class="x-panel x-panel-noborder">
                <div class="x-panel-bwrap">
                    <div class="x-panel-body x-panel-body-noheader">
                        <h2><a href='/' target='_blank'><img src="{$logo}"><span>{$_config.site_name|strip_tags|escape}</span></a></h2>
                        <br class="clear" />
